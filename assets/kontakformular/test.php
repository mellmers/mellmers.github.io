...
$dmsg  = "Wenn Sie diese E-Mail lesen können, wurde das Formular erfolgreich auf Ihrem Server getestet.\n\n";
   $dmsg .= "Sie können nun die Datei test.php löschen und das Kontaktformular [kontakt.php] nutzen. ";
$dmsg .= "Bei Fragen oder Problemen stehen wir Ihnen jederzeit mit unserem kostenlosen Installationsservice zur Verfügung. \n";
...
echo "Das Testformular wurde erfolgreich versandt. Sie sollten innerhalb der nächsten Sekunden eine E-Mail erhalten.";
...
<p><b>Formular zum Testen der Mailfunktion auf Ihrem Server</b><br /><br />Bitte hier Ihre <b>E-Mail Adresse</b> eintragen und auf <b>Senden</b> klicken.<br /><br />Innerhalb weniger Sekunden sollten Sie eine E-Mail erhalten. <br />Diese Datei kann danach gelöscht werden.</p>
...
<fieldset class="kontaktdaten">
	...
	<table>
		<tr>
			<td class="label"><label><b>IHRE E-Mail: </b><span class="pflichtfeld">*</span></label></td>
 ...
 <fieldset class="buttons">
   ...
   <input type="submit" name="kf-km1212" value="Senden" onclick="tescht();"/>
